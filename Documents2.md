...
```python name=standard_libraries.py
...
```python name=siem/config.py url=https://github.com/glutton-su/SIEM-P2-CW1/blob/main/siem/config.py
# ==================== Color Scheme ====================
COLORS = {
    'bg_dark': '#0d1117',
    'bg_secondary': '#161b22',
...
```python name=siem/ui/app.py url=https://github.com/glutton-su/SIEM-P2-CW1/blob/main/siem/ui/app.py
...
```python name=siem/ui/widgets.py url=https://github.com/glutton-su/SIEM-P2-CW1/blob/main/siem/ui/widgets.py
...
```python name=siem/collectors/network_monitor.py url=https://github.com/glutton-su/SIEM-P2-CW1/blob/main/siem/collectors/network_monitor.py
...
```python name=siem/collectors/windows_event.py url=https://github.com/glutton-su/SIEM-P2-CW1/blob/main/siem/collectors/windows_event.py
...
```python name=siem/utils/event_queue.py url=https://github.com/glutton-su/SIEM-P2-CW1/blob/main/siem/utils/event_queue.py
class EventQueue:
...
```python name=siem/collectors/log_file.py url=https://github.com/glutton-su/SIEM-P2-CW1/blob/main/siem/collectors/log_file.py
...
```python name=siem/collectors/syslog_server.py url=https://github.com/glutton-su/SIEM-P2-CW1/blob/main/siem/collectors/syslog_server.py
